...
class NavigationViewModel(
    ...
    val navigationType: ru.dgis.sdk.navigation.State
        get() =
            if (points.any { it != null }) ru.dgis.sdk.navigation.State.NAVIGATION else ru.dgis.sdk.navigation.State.FREE_ROAM
